...
################################################################
# This is a generated script based on design: Bidirectional_Transmitter
#
...
# source Bidirectional_Transmitter_script.tcl
...
set design_name Bidirectional_Transmitter
...
proc create_root_design { parentCell } {
  ...
  set tx_green_LED [ create_bd_port -dir O tx_green_LED ]
  set tx_red_LED [ create_bd_port -dir O tx_red_LED ]

  # Create instance: UART_Reciever_0, and set properties
  set block_name UART_Reciever
  set block_cell_name UART_Reciever_0
  if { [catch {set UART_Reciever_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $UART_Reciever_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: UART_Transmitter_0, and set properties
  set block_name UART_Transmitter
  set block_cell_name UART_Transmitter_0
  if { [catch {set UART_Transmitter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $UART_Transmitter_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: gpio_parse_0, and set properties
  set block_name gpio_parse
  set block_cell_name gpio_parse_0
  if { [catch {set gpio_parse_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
  ...
  connect_bd_net -net UART_Transmitter_0_red_LED [get_bd_ports tx_red_LED] [get_bd_pins UART_Transmitter_0/red_LED]
