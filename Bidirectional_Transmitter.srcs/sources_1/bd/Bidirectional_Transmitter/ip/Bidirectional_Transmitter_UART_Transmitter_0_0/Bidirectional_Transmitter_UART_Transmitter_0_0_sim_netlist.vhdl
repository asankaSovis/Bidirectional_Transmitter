...
--               C:/Xilinx/projects/Bidirectional_Transmitter/Bidirectional_Transmitter.srcs/sources_1/bd/Bidirectional_Transmitter/ip/Bidirectional_Transmitter_UART_Transmitter_0_0/Bidirectional_Transmitter_UART_Transmitter_0_0_sim_netlist.vhdl
...
entity Bidirectional_Transmitter_UART_Transmitter_0_0_bit_counter_tx is
  port (
  ...
  attribute ORIG_REF_NAME of Bidirectional_Transmitter_UART_Transmitter_0_0_bit_counter_tx : entity is "bit_counter_tx";
end Bidirectional_Transmitter_UART_Transmitter_0_0_bit_counter_tx;

architecture STRUCTURE of Bidirectional_Transmitter_UART_Transmitter_0_0_bit_counter_tx is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Bidirectional_Transmitter_UART_Transmitter_0_0_tx_clock is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Bidirectional_Transmitter_UART_Transmitter_0_0_tx_clock : entity is "tx_clock";
end Bidirectional_Transmitter_UART_Transmitter_0_0_tx_clock;

architecture STRUCTURE of Bidirectional_Transmitter_UART_Transmitter_0_0_tx_clock is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Bidirectional_Transmitter_UART_Transmitter_0_0_UART_Transmitter is
  port (
    dout : out STD_LOGIC;
    red_LED : out STD_LOGIC;
    green_LED : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Bidirectional_Transmitter_UART_Transmitter_0_0_UART_Transmitter : entity is "UART_Transmitter";
end Bidirectional_Transmitter_UART_Transmitter_0_0_UART_Transmitter;

architecture STRUCTURE of Bidirectional_Transmitter_UART_Transmitter_0_0_UART_Transmitter is
...
module1: entity work.Bidirectional_Transmitter_UART_Transmitter_0_0_tx_clock
     port map (
      int_clk => int_clk,
      state => state,
      tx_clk => tx_clk
    );
module2: entity work.Bidirectional_Transmitter_UART_Transmitter_0_0_bit_counter_tx
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Bidirectional_Transmitter_UART_Transmitter_0_0 is
  port (
    int_clk : in STD_LOGIC;
    tx_axgpio : in STD_LOGIC_VECTOR ( 8 downto 0 );
    dout : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of Bidirectional_Transmitter_UART_Transmitter_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Bidirectional_Transmitter_UART_Transmitter_0_0 : entity is "Bidirectional_Transmitter_UART_Transmitter_0_0,UART_Transmitter,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Bidirectional_Transmitter_UART_Transmitter_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of Bidirectional_Transmitter_UART_Transmitter_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Bidirectional_Transmitter_UART_Transmitter_0_0 : entity is "UART_Transmitter,Vivado 2018.2";
end Bidirectional_Transmitter_UART_Transmitter_0_0;

architecture STRUCTURE of Bidirectional_Transmitter_UART_Transmitter_0_0 is
...
begin
inst: entity work.Bidirectional_Transmitter_UART_Transmitter_0_0_UART_Transmitter
     port map (
      dout => dout,
      green_LED => green_LED,
      int_clk => int_clk,
