...
HD_PWD='C:/Xilinx/projects/Bidirectional_Transmitter/Bidirectional_Transmitter.runs/Bidirectional_Transmitter_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bidirectional_Transmitter_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bidirectional_Transmitter_xbar_0.tcl
