...
HD_PWD='C:/Xilinx/projects/Bidirectional_Transmitter/Bidirectional_Transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bidirectional_Transmitter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bidirectional_Transmitter_wrapper.tcl -notrace
