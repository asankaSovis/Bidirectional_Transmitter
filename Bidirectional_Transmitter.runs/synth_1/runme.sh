...
HD_PWD='C:/Xilinx/projects/Bidirectional_Transmitter/Bidirectional_Transmitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bidirectional_Transmitter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bidirectional_Transmitter_wrapper.tcl
